...
@php
  ...
  $ticketsMenuOpen = request()->routeIs('admin.tickets.*')
      || request()->routeIs('admin.guest-lists.*');
@endphp
            ...
            <ul class="nav-main-submenu">
              <li class="nav-main-item">
                <a class="nav-main-link {{ request()->routeIs('admin.tickets.*') ? 'active' : '' }}"
                  ...
                  <span class="nav-main-link-name">Sales Tickets</span>
                </a>
              </li>
              <li class="nav-main-item">
                <a class="nav-main-link {{ request()->routeIs('admin.guest-lists.*') ? 'active' : '' }}"
                   href="{{ route('admin.guest-lists.index') }}">
