...
.db-filter-btn:focus { font-size:12px; color:var(--muted) !important; background:var(--surface); border:1px solid var(--border); border-radius:999px; padding:7px 12px; text-decoration:none; transition:all .2s; }
.db-filter-btn:hover { color:var(--gold) !important; border-color:rgba(245,184,0,0.3); }
.db-filter-btn.active,
.db-filter-btn.active:visited,
.db-filter-btn.active:focus { color:#111 !important; background:var(--gold); border-color:var(--gold); font-weight:700; }
...
.db-pending-alert:focus { background: rgba(245,184,0,0.06); border: 1px dashed rgba(245,184,0,0.3); border-radius: 8px; padding: 12px 16px; display: flex; align-items: center; gap: 10px; font-size: 13px; color: var(--gold) !important; margin-bottom: 20px; text-decoration: none; transition: background 0.2s; }
.db-pending-alert span,
.db-pending-alert strong,
.db-pending-alert i { color: var(--gold) !important; }
.db-pending-alert:hover { background: rgba(245,184,0,0.1); color: var(--gold) !important; }
